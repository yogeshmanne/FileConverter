...
layout = [
    [sg.Text('User Input Form', size=(30, 1), justification='center', font=("Helvetica", 25))],
    [sg.Text('Name', size=(15, 1), font=("Helvetica", 15)), sg.InputText(key='name', font=("Helvetica", 15))],
    [sg.Text('Email ID', size=(15, 1), font=("Helvetica", 15)), sg.InputText(key='email', font=("Helvetica", 15))],
    [sg.Text('Phone Number', size=(15, 1), font=("Helvetica", 15)), sg.InputText(key='phone', font=("Helvetica", 15))],
    [sg.Text('Branch', size=(15, 1), font=("Helvetica", 15)), 
    ...
    [sg.Submit(font=("Helvetica", 15)), sg.Button('Clear', font=("Helvetica", 15)), sg.Exit(font=("Helvetica", 15))],
    [sg.Text('Download as:', size=(15, 1), font=("Helvetica", 15)), sg.Combo(['json', 'txt', 'xml', 'xlsx'], key='file_format', default_value='xlsx', font=("Helvetica", 15)), sg.Button('Download', font=("Helvetica", 15))]
]
